...
- **Build Command**: `pip install --upgrade pip && pip install -r requirements-production-no-torch.txt`
...
- In Render dashboard:
  ...
  2. Change Build Command to: `pip install --upgrade pip && pip install -r requirements-production-no-torch.txt`
  3. Save and redeploy
