    ...
    <AppLayout user={user}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-500">Get personalized investment recommendations based on your risk profile calculated from all 15 onboarding questions</p>
        </div>

        {/* Investment Amount Input */}
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">How much do you want to invest?</h3>
        ...
        {recommendations && (
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <div className="mb-6">
              ...
              <div className={`inline-block px-4 py-2 rounded-lg border-2 ${getRiskColor(recommendations.risk_level)}`}>
                <p className="font-semibold">
                  Level {recommendations.risk_level}: {recommendations.risk_label}
                </p>
              </div>
              <p className="mt-3 text-gray-600">
                Based on your 15 onboarding questions and investment amount of {formatCurrency(recommendations.amount)}, here are your personalized recommendations:
              </p>
            </div>
