        ...
        <div className="bg-[#252525] rounded-xl shadow-sm p-4 sm:p-6 border border-gray-800 overflow-hidden" style={{ width: '100%', maxWidth: '100%' }}>
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div className="flex items-center space-x-2 sm:space-x-3 min-w-0">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-600 rounded-full flex items-center justify-center text-xl sm:text-2xl flex-shrink-0">
                🤖
              </div>
              <div className="min-w-0">
                <h2 className="text-xl sm:text-2xl font-bold text-white break-words" style={{ wordBreak: 'break-word' }}>AI Finance Advisor</h2>
                <p className="text-sm sm:text-base text-gray-400 break-words" style={{ wordBreak: 'break-word' }}>Personalized financial advice based on your data</p>
              </div>
            </div>
            <button
              onClick={clearChat}
